...
class MarkItDown:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Desativamos o Magika completamente no DocFlow para otimizar memória e evitar deadlocks
        self._magika = None
    ...
    def _get_stream_info_guesses(
        ...
        # Desativamos o Magika por padrão em todos os ambientes (local e produção).
        # Como o DocFlow já valida a extensão do arquivo no Flask (ALLOWED_EXTENSIONS),
        # a adivinhação profunda via IA do Magika/ONNX Runtime é desnecessária e causava
        # travamento (deadlock) nos containers Linux do Railway devido ao pool de threads.
